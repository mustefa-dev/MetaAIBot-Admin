...
export const localeLoaders = {
  ar: [
    {
      key: "locale_ar_46json_c294abb3",
      load: () => import("#nuxt-i18n/c294abb3" /* webpackChunkName: "locale_ar_46json_c294abb3" */),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_f3910322",
      load: () => import("#nuxt-i18n/f3910322" /* webpackChunkName: "locale_en_46json_f3910322" */),
      cache: true
    }
  ]
}
...
async function loadCfg(config) {
  ...
  import.meta.hot.accept("../locales/ar.json", async mod => {
